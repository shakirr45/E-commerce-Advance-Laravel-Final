        ...
        <div class="row">
              ...
              <div class="card-header">
                ...
                <div class="row">
                  ...
                  <div class="form-group col">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" name="name"  required="" value="{{ $product->name }}">
                  </div>
                  <div class="form-group col">
                    <label for="exampleInputEmail1">Product Code</label>
                    <input type="text" class="form-control" id="exampleInputEmail1" name="code"  required="" value="{{ $product->code }}">
                  </div>
                  ...
                  <div class="form-group col">
                    ...
                    <div class="form-group col">
                      ...
                      <select class="form-control select2" name="pickup_point_id">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" name="unit"  required="" value="{{ $product->unit }}">
                  </div>
                  
                  <div class="form-group col">
                    <label for="exampleInputPassword1">Tags</label><br>
                    <input type="text" class="form-control" id="exampleInputPassword1" data-role="tagsinput" name="tags" value="{{ $product->tags }}">
                  </div>
                    ...
                    <div class="form-group col">
                      ...
                      <input type="text" class="form-control" id="exampleInputEmail1" name="purchase_price"  value="{{ $product->purchase_price }}">
                    </div>
                    <div class="form-group col">
                      <label for="exampleInputPassword1">Selling Price</label>
                      <input type="text" class="form-control" id="exampleInputPassword1" name="selling_price"  required=""  value="{{ $product->selling_price }}">
                    </div>
                    <div class="form-group col">
                      <label for="exampleInputPassword1">Discount Price</label>
                      <input type="text" class="form-control" id="exampleInputPassword1" name="discount_price" value="{{ $product->discount_price }}">
                    </div>
                  ...
                  <div class="form-group col">
                    ...
                    <input type="text" class="form-control" id="exampleInputPassword1" data-role="tagsinput" name="color" value="{{ $product->color }}">
                  </div>
                  <div class="form-group col-4">
                    <label for="exampleInputPassword1">Size</label>
                    <input type="text" class="form-control" id="exampleInputPassword1" data-role="tagsinput" name="size" value="{{ $product->size }}">
                  </div>
                    ...
                    <textarea class="form-control textarea" id="summernote" name="description" rows="10" >{{ $product->description }}</textarea>
                    ...
                    <input type="text" class="form-control" id="exampleInputPassword1" name="video"  value="{{ $product->video }}">
                  </div>
          ...
          <div class="col-lg-4">
            ...
            <div class="card card-dark">
              <div class="card-header">
                <img src="{{ asset('public/files/product/'.$product->thumbnail) }}" style="height:50px; width:50px;" alt="">
                <h3 class="card-title">Main Thumbnail</h3>
              </div>
              <div class="card-body">
              <label class="form-label" for="customFile">Default file input example</label>
                <input type="file" class="form-control" id="customFile" name="thumbnail"/>
                <input type="hidden" class="form-control" name="old_thumbnail" value="{{ $product->thumbnail }}"/>
                  ...
                  <table class="table table-bordered" id="dynamic_field">
                    ...
                    <div class="row">
                      @foreach($images as $key => $image)
                        <div class="col-md-4">
                          <img src="{{ asset('public/files/product/'.$image) }}" style="width: 100px; height:80px; padding:10px;" alt="">
            ...
            <div class="card card-dark">
                ...
                <div class="card-body">
                    ...
                    <input type="checkbox"  @if($product->featured == 1) checked @endif data-bootstrap-switch data-off-color="danger" data-on-color="success" name="featured" value="1">
                ...
                <div class="card-body">
                    <input type="checkbox"  @if($product->today_deal == 1) checked @endif data-bootstrap-switch data-off-color="danger" data-on-color="success" name="today_deal" value="1">
                </div>
                </div>
                ...
                <div class="card-body">
                    <input type="checkbox" @if($product->product_slider == 1) checked @endif  data-bootstrap-switch data-off-color="danger" data-on-color="success" name="product_slider" value="1">
                </div>
                </div>
                ...
                <div class="card-body">
                    <input type="checkbox"  @if($product->status == 1) checked @endif data-bootstrap-switch data-off-color="danger" data-on-color="success" name="status" value="1">
                </div>
                </div>
