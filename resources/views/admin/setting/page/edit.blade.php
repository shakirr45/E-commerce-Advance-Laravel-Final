...
<select name="page_position" class="form-control" >
  ...
  <option value="1" {{ ($page->page_position==2) ? "selected" : "" }}>Line 2</option>
...
<input type="text" class="form-control" placeholder="Page Name" name="page_name" value="{{ $page->page_name }}">
</div>

<div class="form-group">
<label for="exampleInputPassword1">Page Title</label>
<input type="text" class="form-control" placeholder="Page Title" name="page_title"  value="{{ $page->page_title }}">
</div>
...
<textarea  class="form-control textarea" id="summernote" name="page_description" rows="10">{{ $page->page_description }}</textarea>
