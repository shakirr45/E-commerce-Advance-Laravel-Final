              ...
              <div class="card-header">
                ...
                <div class="row">
                  ...
                  <div class="form-group col-lg-6">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" name="name"  required="" value="{{ $data->name }}">
                  </div>
                  <div class="form-group col-lg-6">
                    <label for="exampleInputEmail1">Employee Email</label>
                    <input type="email" class="form-control" id="exampleInputEmail1" name="email"  required="" value="{{ $data->email }}">
                  </div>
